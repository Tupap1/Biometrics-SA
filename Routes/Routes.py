...
@pruebaroutes.route("/crearestanque", methods=["POST"])
def crearestanque():
    if request:
...
@pruebaroutes.route("/consultarestanque", methods=["GET"])
...
@pruebaroutes.route('/estanque/<int:id_estanque>')
...
@pruebaroutes.route('/estanque/<int:id_estanque>', methods=['PUT'])
